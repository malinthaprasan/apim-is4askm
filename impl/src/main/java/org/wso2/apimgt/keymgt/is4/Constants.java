...
public class Constants {
    ...
    public static final String IS4_DEFAULT_SCOPE_DEFAULT = "NHGateway";
    public static final String IS4_DEFAULT_SCOPE = "DefaultScope";
    public static final String AUTHORIZATION_HEADER_SPLITTER = "__###__";
    ...
    public static final String ADDED_SCOPES = "addedScopes";
    public static final String REMOVED_SCOPES = "removedScopes";
